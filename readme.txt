...
Christian Okoli was responsible for the StarObject and Body class. The body class serve as a planet in the Universe. They will have a velocity, location, and mass by inheriting from the StarObject. The body class  use its draw function to convert coridnates for SFML. The step function calculates the new position and velocity in relation to the change in time. Christian was responsible for unit testing the conversion, velocity, and step function.
